...
Function OnOptionSelect(TTM_MCM mcm, int option) global
    ...
    elseif(option == mcm.oid_SettingsAIMiscDial)
        ...
        TTM_Debug.trace("OnOptionSelect:oid_SettingsAIMiscDial:"+main+":"+conditions)
...
Function OnOptionHighlight(TTM_MCM mcm, int option) global
    ...
    elseif(option == mcm.oid_SettingsExportData)
        mcm.SetInfoText("Exports json data to file in Documents\\My Games\\Skyrim Special Edition\\JCUser\\MARAS\\main.json")
    elseif(option == mcm.oid_SettingsImportData)
        mcm.SetInfoText("Imports data from file in Documents\\My Games\\Skyrim Special Edition\\JCUser\\MARAS\\main.json")
    elseif(option == mcm.oid_SettingsAIMiscDial)
